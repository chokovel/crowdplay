...
<body>
                        ...
                        <div class="col-6 col-lg-6 col-xl-3">
                            <div class="tp-header-right d-flex align-items-center justify-content-xxl-end">
                                ...
                                <div class="tp-header-btn p-relative d-none d-xl-block">
                                    <a class="tp-btn" href="{{ '/artist-form' }}"><i
                                            class="fa-light fa-calendar-days"></i> Book an Artist</a>
                                </div>
                    ...
                    <ul>
                        <li class="d-flex align-items-center">
                            <div class="tp-sidebar__contact-text">
                                <a target="_blank"
                                    href="https://www.google.com/maps/place/Maricopa,+AZ,+USA/@33.0435146,-112.0317544,13z/data=!3m1!4b1!4m5!3m4!1s0x872ae52ea99557e3:0x702c0500cea3bb0!8m2!3d33.0581063!4d-112.0476423"><i
                                        class="fal fa-map-marker-alt"></i> CrowdPlay Studios, Kemdy Plaza,By phase3
                                    Gate,Army Post Service Housing Estate, Kurudu, Abuja.</a>
                            </div>
                        </li>
                        <li class="d-flex align-items-center">
                            <div class="tp-sidebar__contact-text">
                        ...
                        <li class="d-flex align-items-center">
                            <div class="tp-sidebar__contact-text">
                                <a href="mailto:crowdplayabuja@gmail.com"><i class="fal fa-envelope"></i>
                                    crowdplayabuja@gmail.com</a>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <main>
        ...
        <section class="breadcrumb__area breadcrumb-style pt-130 pb-115 p-relative z-index-1"
            data-background="assets/img/breadcrumb/art-bg.jpg">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="tp-contact-location d-sm-flex justify-content-xl-start">
                            ...
                            <div class="contact-inner">
                                <p>Address:</p>
                                <a target="_blank" href="https://goo.gl/maps/Xqapuk42Afn87C6L7">Kemdy Plaza, By phase3
                                    Gate, Army Post Service Housing Estate, Kurudu, Abuja.</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <form id="contact-form" action="{{ route('contact.submit') }}" method="POST"
                                ...
                                <div class="row tp-gx-20">
                                    ...
                                    <div class="col-12 col-sm-6" id="services_option">
                                        ...
                                        <div class="tp-brands-from-input contact-mb">
                                            <select id="book-type" name="service" class="wide"
                                            ...
                                            <div class="nice-select wide" tabindex="0">
                                                ...
                                                <ul id="services_option" class="list">
                                                    <li data-value="Choose Service:" class="option selected">Choose
                                                        Service:</li>
                                                    <li id="artist" data-value="Book Artist" class="option">Book
                                                        Artist</li>
                                                    <li id="session" data-value="Book Session" class="option">Book
                                                        Session</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    <div id="comment1" class="col-12 tp-brands-from-input contact-mb"
                                        style="display:none;">
                                        Send us details of your choice of artist, event date and time, location and any
                                        other important note and we will get back to you shortly.
                                    </div>
                                    <div id="comment2" class="col-12 tp-brands-from-input contact-mb"
                                        style="display:none;">
                                        Full Session: Eight Thousand Naira <br />
                                        Half Session: Four Thousand Naira <br />
                                        Choose a session and give details of the activity you want to perform and we
                                        will get back to you with the schedule and payment details.
                                    </div>
                                    <div class="col-12">
                                ...
                                <div class="tp-contact-submit text-center mt-20">
                                    <button class="btn btn-info btn-large" type="submit">Send Message <i
                ...
                <div class="row gx-0">
                    <div class="col-lg-12">
                        <div class="tp-contact-map">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d492.67063589111706!2d7.548774098977437!3d8.938465064817226!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e0f3f9126a045%3A0x514dfef7982f2a98!2sNigerian%20Army%20Post-service%20Development%20Estate%20Kurudu%20Phase%202!5e0!3m2!1sen!2sng!4v1682771098641!5m2!1sen!2sng"
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-4 col-lg-6">
                                    <div class="tp-footer-logo">
                                        <a href="{{ '/' }}">
                                            <img style="width:60px" src="assets/img/logo/logo.png"
                                                alt="crowdplay logo">
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="tp-footer-widget-contact d-flex align-items-center">
                                        ...
                                        <div class="contact-inner">
                                            ...
                                            <a style="font-size: 16px"
                                                href="mailto:crowdplayabuja@gmail.com">crowdplayabuja@gmail.com</a>
                                        </div>
                                    </div>
                                    <div class="tp-footer-widget-contact d-flex align-items-center">
                                        ...
                                        <div class="contact-inner">
                                            <p>Address:</p>
                                            <a style="font-size: 16px" href="#">CrowdPlay Studios, Kemdy Plaza,
                                                By phase3 Gate, Army Post Service Housing Estate, Kurudu, Abuja</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-12">
                            <p class="text-center">Copyright ©
                                ...
                                </script> CrowdPlay. All Rights Reserved
                            </p>
                        </div>
                    </div>
                </div>
